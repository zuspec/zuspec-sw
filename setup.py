...
zuspec_sw_dir = os.path.dirname(os.path.abspath(__file__))

if os.path.isdir(os.path.join(zuspec_sw_dir, "packages")):
    print("Packages are inside this directory")
    packages_dir = os.path.join(zuspec_sw_dir, "packages")
else:
    parent = os.path.dirname(zuspec_sw_dir)
...
ext = Extension("zsp_sw.core",
            extra_compile_args=extra_compile_args,
            sources=[
                os.path.join(zuspec_sw_dir, 'python', "core.pyx"), 
            ],
            language="c++",
            include_dirs=[
                os.path.join(zuspec_sw_dir, 'python'),
                os.path.join(zuspec_sw_dir, 'src', 'include'),
...
setup(
  ...
  url = "https://github.com/zuspec/zuspec-sw",
  setup_requires=[
    'setuptools_scm',
  ],
  install_requires=[
